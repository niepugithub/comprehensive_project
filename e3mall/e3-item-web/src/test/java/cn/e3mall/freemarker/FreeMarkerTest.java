...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		Writer out = new FileWriter(new File("H:\\local_git_repository\\comprehensive_project\\e3mall\\e3-item-web\\src\\test\\java\\cn\\e3mall\\freemarker\\html\\student.html"));
		//8、生成静态页面
